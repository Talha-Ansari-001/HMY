          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
            <div className="max-w-xl text-center lg:text-left">
              ...
              <p className="text-slate-400 font-medium leading-relaxed italic">
                Stay updated with HMY English School’s latest news, academic announcements, and SSC board updates.
              </p>
            </div>
          ...
          <div className="space-y-10">
            <div className="flex items-center gap-4 group cursor-pointer">
              ...
              <div className="flex flex-col">
                <span className="font-serif text-2xl font-black text-brand-gold leading-none tracking-tight">HMY ENGLISH</span>
                <span className="text-[10px] uppercase tracking-[0.4em] text-white/40 mt-1 font-black">School of Excellence</span>
              </div>
            </div>
            <p className="text-sm leading-relaxed text-slate-400 font-medium">
              A Tradition of Excellence, Innovation, and Character Building since 1995. Dedicated to nurturing the future leaders of Maharashtra.
            </p>
          ...
          <div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-5">
                ...
                <p className="text-sm font-medium text-slate-400">info@hmyenglishschool.edu.in</p>
              </div>
              <div className="flex items-center gap-5">
                <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center flex-shrink-0 text-brand-gold border border-white/5">
                  <Clock size={20} />
        ...
        <div className="mt-24 pt-10 border-t border-white/5 flex flex-col lg:flex-row justify-between items-center gap-8 text-center lg:text-left">
          <div className="space-y-2">
            <p className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-500">
              &copy; {new Date().getFullYear()} HMY English School. All rights reserved.
            </p>
          ...
          <div className="flex flex-col items-center lg:items-end gap-3">
             ...
             >
                Designed by <span className="text-white">Your Agency Name</span>
             </motion.div>
          </div>
        </div>
      </div>
